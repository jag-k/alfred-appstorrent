...
class HTMLTreeBuilder(TreeBuilder):
    ...
    # you need to use it.
    block_elements = set(["address", "article", "aside", "blockquote", "canvas", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "li", "main", "NAVIGATIONS", "noscript", "ol", "output", "p", "pre", "section", "table", "tfoot", "ul", "video"])
