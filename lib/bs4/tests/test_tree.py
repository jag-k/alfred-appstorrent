...
class TestTreeModification(SoupTest):
    ...
    def test_extract(self):
        soup = self.soup(
            '<html><body>Some content. <div id="NAVIGATIONS">Nav crap</div> More content.</body></html>')

        self.assertEqual(len(soup.body.contents), 3)
        extracted = soup.find(id="NAVIGATIONS").extract()

        self.assertEqual(
            soup.decode(), "<html><body>Some content.  More content.</body></html>")
        self.assertEqual(extracted.decode(), '<div id="NAVIGATIONS">Nav crap</div>')
...
<script>baz</script>
 ...
 '</html>')
    ...
    def test_decompose(self):
        # Test rElement.decompose() and rElement.decomposed
...
class TestPersistence(SoupTest):
    ...
    def setUp(self):
        ...
        self.r = """<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"
